...
if ( ! class_exists( 'ObsiusCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class ObsiusCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'obsius_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return ObsiusCore_Dashboard_Rest_API
		 */
	...
	ObsiusCore_Dashboard_Rest_API::get_instance();
}

...
if ( ! function_exists( 'obsius_core_add_page_mobile_logo_meta_box' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function obsius_core_add_page_mobile_logo_meta_box( $logo_tab ) {
		...
		if ( $logo_tab ) {
			...
			$mobile_header_logo_section = $logo_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Mobile Header Logo Options', 'obsius-core' ),
				)
			);
			...
			$mobile_header_logo_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Logo Height', 'obsius-core' ),
					'description' => esc_html__( 'Enter mobile logo height', 'obsius-core' ),
					'args'        => array(
			...
			$mobile_header_logo_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Logo Padding', 'obsius-core' ),
					'description' => esc_html__( 'Enter mobile logo padding value (top right bottom left)', 'obsius-core' ),
				)
			);
			...
			$mobile_header_logo_section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Mobile Logo Source', 'obsius-core' ),
					'options'       => array(
			...
			$logo_image_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Logo - Main', 'obsius-core' ),
					'description' => esc_html__( 'Choose main mobile logo image', 'obsius-core' ),
					'multiple'    => 'no',
				)
			);

			// Hook to include additional options after section part
			do_action( 'obsius_core_action_after_mobile_logo_image_section_meta_map', $logo_tab, $mobile_header_logo_section, $logo_image_section );
			...
			// Hook to include additional options after section part
			do_action( 'obsius_core_action_after_mobile_logo_svg_path_section_meta_map', $logo_tab, $mobile_header_logo_section, $logo_svg_path_section );
			...
			// Hook to include additional options after section part
			do_action( 'obsius_core_action_after_mobile_logo_textual_section_meta_map', $logo_tab, $mobile_header_logo_section, $logo_textual_section );

			// Hook to include additional options after module options
			do_action( 'obsius_core_action_after_page_mobile_logo_meta_map', $mobile_header_logo_section );
		}
	}

	add_action( 'obsius_core_action_after_page_mobile_header_meta_map', 'obsius_core_add_page_mobile_logo_meta_box' );
}

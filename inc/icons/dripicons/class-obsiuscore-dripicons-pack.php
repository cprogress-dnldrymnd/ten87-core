...
if ( ! function_exists( 'obsius_core_add_dripicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function obsius_core_add_dripicons_to_collection( $icons ) {
		$icons[] = 'ObsiusCore_Dripicons_Icon_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'obsius_core_add_dripicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class ObsiusCore_Dripicons_Icon_Pack extends QodeFrameworkIconPack {
		...
		function specific_icons() {
			return apply_filters(
				'obsius_core_filter_dripicons_specific_icons',
				array(

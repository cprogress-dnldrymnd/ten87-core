...
if ( ! function_exists( 'obsius_core_add_portfolio_list_double_image_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function obsius_core_add_portfolio_list_double_image_shortcode( $shortcodes ) {
		$shortcodes[] = 'ObsiusCore_Portfolio_List_Double_Image_Shortcode';

		return $shortcodes;
	}

	add_filter( 'obsius_core_filter_register_shortcodes', 'obsius_core_add_portfolio_list_double_image_shortcode' );
}

if ( class_exists( 'ObsiusCore_List_Shortcode' ) ) {
	class ObsiusCore_Portfolio_List_Double_Image_Shortcode extends ObsiusCore_List_Shortcode {
		...
		public function __construct() {
			...
			$this->set_layouts( apply_filters( 'obsius_core_filter_portfolio_list_double_image_layouts', array() ) );
			$this->set_extra_options( apply_filters( 'obsius_core_filter_portfolio_list_double_image_extra_options', array() ) );
			$this->set_hover_animation_options( apply_filters( 'obsius_core_filter_portfolio_list_double_image_hover_animation_options', array() ) );

			parent::__construct();
		}

		public function map_shortcode() {
			$this->set_shortcode_path( OBSIUS_CORE_CPT_URL_PATH . '/portfolio/shortcodes/portfolio-list-double-image' );
			$this->set_base( 'obsius_core_portfolio_list_double_image' );
			$this->set_name( esc_html__( 'Portfolio List Double Image', 'obsius-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays list of portfolios', 'obsius-core' ) );
			$this->set_scripts( apply_filters( 'obsius_core_filter_portfolio_list_double_image_register_assets', array() ) );
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'custom_class',
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'obsius_core_portfolio_list_double_image', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function load_assets() {
			...
			do_action( 'obsius_core_action_portfolio_list_double_image_load_assets', $this->get_atts() );
		}
		...
		public function render( $options, $content = null ) {
			...
			$atts['data_attr']         = obsius_core_get_pagination_data( OBSIUS_CORE_REL_PATH, 'post-types/portfolio/shortcodes', 'portfolio-list-double-image', 'portfolio', $atts );

			$atts['this_shortcode'] = $this;

			return obsius_core_get_template_part( 'post-types/portfolio/shortcodes/portfolio-list-double-image', 'templates/content', $atts['behavior'], $atts );
		}

		private function get_holder_classes( $atts ) {
			$holder_classes = $this->init_holder_classes();

			$holder_classes[] = 'qodef-portfolio-list-double-image';

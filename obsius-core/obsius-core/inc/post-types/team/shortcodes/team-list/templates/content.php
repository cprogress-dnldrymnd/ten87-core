<div <?php qode_framework_class_attribute( $holder_classes ); ?> <?php qode_framework_inline_attr( $data_attr, 'data-options' ); ?>>
	<?php
	// Include items
	obsius_core_template_part( 'post-types/team/shortcodes/team-list', 'templates/top-info', '', $params );
	...
	<div class="qodef-grid-inner clear">
		...
		// Include items
		obsius_core_template_part( 'post-types/team/shortcodes/team-list', 'templates/loop', '', $params );
		?>
	</div>
	<?php

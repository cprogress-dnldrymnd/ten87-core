...
if ( ! class_exists( 'ObsiusCore_Shortcodes' ) ) {
	class ObsiusCore_Shortcodes {
		...
		function init() {
			...
			include_once OBSIUS_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once OBSIUS_CORE_SHORTCODES_PATH . '/class-obsiuscore-shortcode.php';
			include_once OBSIUS_CORE_SHORTCODES_PATH . '/class-obsiuscore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'obsius_core_filter_register_shortcodes', $shortcodes = array() );
	...
	ObsiusCore_Shortcodes::get_instance();
}

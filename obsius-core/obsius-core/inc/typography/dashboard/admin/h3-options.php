...
if ( ! function_exists( 'obsius_core_add_h3_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function obsius_core_add_h3_typography_options( $page ) {
		...
		if ( $page ) {
			$h3_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h3',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H3 Typography', 'obsius-core' ),
					'description' => esc_html__( 'Set values for Heading 3 HTML element', 'obsius-core' ),
				)
			);
			...
			$h3_1366_typography_section = $h3_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 1366 Typography', 'obsius-core' ),
				)
			);
			...
			$h3_1024_typography_section = $h3_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 1024 Typography', 'obsius-core' ),
				)
			);
			...
			$h3_768_typography_section = $h3_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 768 Typography', 'obsius-core' ),
				)
			);
			...
			$h3_680_typography_section = $h3_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 680 Typography', 'obsius-core' ),
				)
			);
	...
	add_action( 'obsius_core_action_after_typography_options_map', 'obsius_core_add_h3_typography_options' );
}

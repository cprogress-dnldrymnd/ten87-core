...
class ObsiusCore_Standard_Header extends ObsiusCore_Header {
	...
	/**
	 * @return ObsiusCore_Standard_Header
	 */
	...
	function get_menu_position() {
		return obsius_core_get_post_value_through_levels( 'qodef_standard_header_menu_position' );
	}
